...
def prepare_datasets(device, train_files, test_files, hidden1, hidden2, dropout, batch_size, min_executed=0):
    ...
    return model, train_loader, test_loader, num_features, scaler, reg_vocab, opc_vocab, feature_columns, test_df_raw
...
def objective(trial, train_files, test_files, min_executed=0):
    ...
    model, train_loader, test_loader, num_features, scaler, reg_vocab, opc_vocab, feature_columns, _ = prepare_datasets(
...
def run_fold(test_file, device, min_executed=0):
    ...
    model, train_loader, test_loader, num_features, scaler, reg_vocab, opc_vocab, feature_columns, test_df_raw = prepare_datasets(
        device, train_files, test_files,
